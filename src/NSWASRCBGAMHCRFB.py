...
class OutConv(nn.Module):
    def __init__(self, in_channels, out_channels,n_channels):
        ...
        self.class_1_variant_guide = DoubleConv(n_channels*2,n_channels*2)
        self.class_2_variant_guide = DoubleConv(n_channels*2,n_channels*2)
        self.class_4_variant_guide = DoubleConv(n_channels*2,n_channels*2)
...
class NSWASRCBGAMHCRFB(nn.Module):
    def __init__(self, n_channels, n_classes,scale=0.5):
        super(NSWASRCBGAMHCRFB, self).__init__()
