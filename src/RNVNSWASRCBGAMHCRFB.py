...
class RNVNSWASRCBGAMHCRFB(nn.Module):
    def __init__(self, n_channels, n_classes,alpha_path=0.7,scale=0.5):
        super(RNVNSWASRCBGAMHCRFB, self).__init__()
    ...
    def forward(self, x):
        ...
        x = self.up1(x5, self.alpha_path*self.MP1(x_1_res_path,x_2_res_path,x_3_res_path,x_4_res_path)+(1-self.alpha_path)*x4)
        x = self.up2(x, self.alpha_path*self.MP2(x_1_res_path,x_2_res_path,x_3_res_path,x_4_res_path)+(1-self.alpha_path)*x3)
        x = self.up3(x, self.alpha_path*self.MP3(x_1_res_path,x_2_res_path,x_3_res_path,x_4_res_path)+(1-self.alpha_path)*x2)
        x = self.up4(x, self.alpha_path*self.MP4(x_1_res_path,x_2_res_path,x_3_res_path,x_4_res_path)+(1-self.alpha_path)*x1)
        output = self.outc(x)
        return output
