...
_C.MODEL.NORM = 'IN2d' # ('IN' or 'BN') + ('2d' or '3d')
_C.MODEL.NUM_FEATURES_START_UNET = 32
_C.MODEL.CONV_TYPE = 'normal2d' # ('normal' or 'coord') + ('2d' or '3d') 
...
# ---------------------------------------------------------------------------- #
_C.DATASET = CN()
_C.DATASET.IMG_TRAIN_PATH = ''
_C.DATASET.GT_TRAIN_PATH = ''
_C.DATASET.IMG_VAL_PATH = ''
_C.DATASET.GT_VAL_PATH = ''
...
_C.MULTI_HEAD_LOSS_WEIGHT = [5,2,2,2,0.75,0.75,0.75]
_C.N_CLASS = 1
_C.CHANNEL_IN = 3
# # ---------------------------------------------------------------------------- #
# # PLOT_GRAPH_RESULT
